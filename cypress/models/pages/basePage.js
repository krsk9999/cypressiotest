class basePage {
	...
	get getSubmitElement() {
		if (this.phone) {
			...
			throw new Error(
				"No selector provided to get a submit button element"
			);
		}
	}

	get getSelectionsElement() {
		if (this.selections) {
			return cy.get(this.selections).as("selections");
		} else {
			throw new Error("No selector provided to get a selections element");
		}
	}
}
