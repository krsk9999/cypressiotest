	...
	context("Setting up testing data", () => {
		...
		before(() => {
            ...
            cy.fixture("UnbounceData.json").then(d => {
                domainData = d;
                urlUrgent = `${domainData.testPage.url}the-better-path-get-options-urgent/`;
                urlNormal = `${domainData.testPage.url}the-better-path-get-options/`;
        ...
        it('Select URGENT',() =>{
            ...
            cy.navigate(`${baseUrl}the-better-path-selections`, null)
